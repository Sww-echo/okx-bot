这是一份基于你提供的YouTube视频内容整理的《双均线交易系统策略文档》。这份文档旨在将视频中的视觉化描述转化为可供程序化交易（量化开发）参考的逻辑规范。
...
*   **针对策略 A（密集突破）**：
    ...
    *   *逻辑*：如果价格重新回到密集区内部并穿过，说明突破失败（假突破）。
*   **针对策略 B（回踩 MA20）**：
    *   止损位设在**有效跌破/突破 MA20** 时。
    *   *逻辑*：如果价格无法守住 MA20 趋势线，说明短期趋势可能结束或转弱。
